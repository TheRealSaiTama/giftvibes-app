...
export async function GET() {
  const staticPaths = [
    ...
    { path: "/guides/new-year-diary-bulk-order-timeline", freq: "monthly", pri: "0.6" },
    { path: "/guides/logo-print-methods", freq: "monthly", pri: "0.6" },
    { path: "/guides/bulk-diary-specifications", freq: "monthly", pri: "0.6" },
    { path: "/guides/employee-joining-kits", freq: "monthly", pri: "0.6" },
