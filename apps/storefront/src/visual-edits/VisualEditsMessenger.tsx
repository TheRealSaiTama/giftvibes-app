...
export default function HoverReceiver() {
  ...
  const originalSrcRef = React.useRef<string>(""); // track original img src
  const focusedImageElementRef = React.useRef<HTMLImageElement | null>(null); // track the actual img element
